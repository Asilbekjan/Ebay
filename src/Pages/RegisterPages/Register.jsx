      ...
      <div className="container">
        <div className="grid grid-cols-12">
              <div className="col-span-6 flex min-h-screen items-center justify-center">
                <div className="card shadow-xl h-[80vh] rounded-2xl w-[480px] ">
                ...
                <p className="ms-14 mt-3 font-[600] text-[56px] font-[Poppins]">Sing up</p>
                ...
                <p className="ms-[116px] text-[black]/20 mt-3">do you have an account?<Link className="text-blue-500 ms-2" to={'/login'}>Sing up</Link></p>
                </div>
              </div>
