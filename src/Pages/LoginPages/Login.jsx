        ...
        <div className="grid grid-cols-12">
          <div className="col-span-6 flex min-h-screen items-center justify-center">
            <div className="card shadow-xl h-[70vh] rounded-2xl w-[480px] ">
              <img
                className="w-[100px] ms-14 mt-7"
                src="./assets/img/Group 22.png"
                alt=""
              />
              <p className="ms-14 mt-3 text-[16px] text-[#00000080;] ">
                Welcome back !!!
              </p>
              <p className="ms-14 mt-3 font-[600] text-[56px] font-[Poppins]">
                Sing In
              </p>
              ...
              />
              <button
                className=" ms-[180px] bg-blue-700 mt-8 text-xl px-5 py-2 rounded-full text-white"
                onClick={getUser}
              >
                Sing in
              </button>
              <p className="ms-[116px] text-[black]/20 mt-3">
                don't have an account?
                <Link className="text-blue-500 ms-2" to={"/registratsiya"}>
                  Sign up
                </Link>
              </p>
            </div>
          ...
          <div className="col-span-6  h-[100vh] w-1000 relative ">
            ...
            <img
              src="./assets/img/Group 2014.png"
              className="absolute me-10"
              alt=""
            />
          </div>
        </div>
